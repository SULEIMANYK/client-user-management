...
@Component({
  selector: 'app-do-consult-oracle-table',
  templateUrl: './do-consult-oracle-table.component.html',
  styleUrls: ['./do-consult-oracle-table.component.css']
})
export class DoConsultOracleTableComponent  {
  ...
  affichertable(form :any) {
    this.afficherTableServiceService.consulterTableOracle(form.value).subscribe(data => {
      this.tableData  = data;
