...
@Component({
  selector: 'app-do-consult',
  templateUrl: './do-consult.component.html',
  styleUrls: ['./do-consult.component.css']
})
export class DoConsultComponent   {
  ...
  affichertable(form :any) {
    this.afficherTableServiceService.doconsulterID(form.value).subscribe(data => {
      this.tableData  = data;
