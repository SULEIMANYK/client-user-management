...
@Component({
  selector: 'app-display-oracle-table',
  templateUrl: './display-oracle-table.component.html',
  styleUrls: ['./display-oracle-table.component.css']
})
export class DisplayOracleTableComponent    {
  ...
  affichertable(form :any) {
    this.afficherTableServiceService.displayTableOracle(form.value).subscribe(data => {
      this.tableData  = data;
